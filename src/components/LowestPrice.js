...
const LowestPrice = () => {
    const renderList= ((item) =>{
        return (
              <ScrollView style={{padding:5, margin:5 ,borderWidth:1,borderColor:'#0caf9a',borderRadius:10,flex:1,}} scrollEnabled={true}>
               <View style={{}}>
       ...
       return(
           ...
           <Text style={{color:'grey',fontSize:17,fontWeight:'600',padding:4,marginTop:-30}}>Pay Les, Get More</Text>
               <FlatList
